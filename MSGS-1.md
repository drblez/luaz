...
| LUZ10010 | TSOAUTH result RC/RSN/ABEND line | src/tsoauth_cp.asm | Use RC/RSN/ABEND values to diagnose TSO command failures | runtime |
| LUZ11001 | ds.open_dd not implemented | lua/ds.lua | Wait for implementation; use DDNAME I/O via JCL tools | stub |
| LUZ11002 | ds.remove not implemented | lua/ds.lua, src/ds.c | Wait for implementation; use dataset utilities | stub |
| LUZ11003 | ds.rename not implemented | lua/ds.lua, src/ds.c | Wait for implementation; use dataset utilities | stub |
| LUZ11004 | ds.tmpname not implemented | lua/ds.lua, src/ds.c | Wait for implementation; define dataset naming policy | stub |
...
| LUZ15001 | mvs.console not implemented | lua/mvs.lua | Wait for implementation; use SDSF/authorized console access | stub |
