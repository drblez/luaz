...
- При FTP‑синке исходников на МФ происходит автоматическая конвертация
  ASCII→EBCDIC; это считаем нормой и не используем как причину ошибок
  сравнения строк в runtime.
