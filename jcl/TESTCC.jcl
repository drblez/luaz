//TESTCC  JOB (ACCT),'TESTCC',CLASS=A,MSGCLASS=H,NOTIFY=&SYSUID
//         SET HLQ=DRBLEZ
//*
...
//         PEND
//*
//CC      EXEC CCOMP,INFILE=&HLQ..LUA.SRC(TESTC),OUTMEM=TESTC,HLQ=&HLQ
//*
//LKED    EXEC PGM=IEWL,COND=(4,LT)
//SYSPRINT DD SYSOUT=*
//SYSIN    DD DUMMY
//SYSLIB   DD  DISP=SHR,DSN=CEE.SCEELKED
//SYSLIN   DD  DSN=&HLQ..LUA.OBJ(TESTC),DISP=SHR
//SYSLMOD  DD  DSN=&HLQ..LUA.LOAD(TESTC),DISP=SHR
//
