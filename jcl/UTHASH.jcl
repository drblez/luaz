...
//* | DEL1    | Delete OBJ member (expect RC=0)              |
//* | CMP2A   | Compare with missing OBJ (expect RC!=0)      |
//* | MK2     | Recreate OBJ member                          |
//* +---------+----------------------------------------------+
//UTHASH  JOB (ACCT),'UT HASHCMP',CLASS=A,MSGCLASS=H,NOTIFY=&SYSUID
//         SET HLQ=DRBLEZ
//         SET SRCPDS=&HLQ..TST.HASH.SRC
//         SET HASHPDS=&HLQ..TST.HASH.HASH
//         SET OBJPDS=&HLQ..TST.HASH.OBJ
...
//SYSIN    DD *
  ...
  DELETE DRBLEZ.TST.HASH.OBJ PURGE
  SET MAXCC=0
/*
...
//MKOBJ1  EXEC PGM=IEBGENER
//SYSUT1  DD  *
OBJ
//SYSUT2  DD  DSN=&OBJPDS(TEST1),DISP=SHR
//SYSPRINT DD SYSOUT=*
//SYSIN   DD DUMMY
//*
...
//OBJIN    DD  DSN=&OBJPDS(TEST1),DISP=SHR
...
//SYSPRINT DD SYSOUT=*
//SYSIN   DD DUMMY
//* Remove OBJ member to validate compare failure on missing object.
//DEL1    EXEC PGM=IDCAMS
//SYSPRINT DD SYSOUT=*
//SYSIN    DD *
  DELETE DRBLEZ.TST.HASH.OBJ(TEST1) PURGE
  SET MAXCC=0
/*
//CMP2A   EXEC PGM=HASHCMP,PARM='C TEST1 &SRCPDS &HASHPDS'
//STEPLIB  DD  DSN=&LOADLIB,DISP=SHR
//SRCIN    DD  DSN=&SRCPDS(TEST1),DISP=SHR
//OBJIN    DD  DSN=&OBJPDS(TEST1),DISP=SHR
//HASHIN   DD  DSN=&HASHPDS(TEST1),DISP=SHR
